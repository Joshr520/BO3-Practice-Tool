...
struct BGBPreset {
	...
	bool operator==(const BGBPreset& preset) const {
		return m_Name == preset.m_Name;
	}
};
...
struct AutosplitPreset
{
	...
	bool operator==(const AutosplitPreset& preset) const {
		return m_Name == preset.m_Name;
	}
};
...
struct WeaponCamosOrder {
	std::vector<std::string> m_Types;
	std::vector<std::vector<std::string>> m_Camos;
};
...
inline WeaponCamosOrder camosOrder = {
	{
