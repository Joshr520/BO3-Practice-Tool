...
namespace ImGui
{
    ...
    IMGUI_API void          Separator(float thickness_draw = 1.0f);                                                    // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
